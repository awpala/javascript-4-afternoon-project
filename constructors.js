...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  Movie.prototype.changeRating = function(newRating) {
    const averageRating = (newRating + this.rating)/2;
...
User.prototype.addSavedPost = function(id, title, rating) {
  ...
  User.prototype.removeSavedPost = function(id) {
    const postId = this.savedPosts.findIndex(el => el.id === id);
    this.savedPosts.splice(postId, 1);
  }
  ...
  User.prototype.changePostRating = function(id, newRating) {
    const postIndex = this.savedPosts.findIndex(el => el.id === id);
    this.savedPosts[postIndex].rating = newRating;
  }